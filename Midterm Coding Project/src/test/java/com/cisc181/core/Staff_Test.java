...
public class Staff_Test {
	...
	{
		StaffMembers.add(new Staff("John", "B", "Doe", staffDate(1987, 2, 8), "123 Fairytale Drive", "(302)-123-4567", "jbd@aol.com",  "Graveyard: Mon 2-4", 1, 30000, staffDate(2000, 7, 17), eTitle.MRS));
		...
		StaffMembers.add(new Staff("Cathy", "Jelly", "Grifiin", staffDate(1952, 6, 12), "32 Main Street", "(911)-249-7760", "jjtheplane@yahoo.com", "Bridekirk: Tues 7-9", 3, 25400, staffDate(1999, 1, 15), eTitle.MS));
